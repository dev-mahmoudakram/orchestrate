...
export default function EnglishHomePage() {
  return (
    <main className="orchestration-grid min-h-screen bg-soft py-16">
      <Container>
        <Badge tone="turquoise">English route</Badge>
        <SectionHeader
          description="Foundation for the secondary English public experience. CMS content and UI labels will be connected in later phases."
          eyebrow="Orchestrate Innovation"
          title="Bilingual corporate website and custom CMS foundation"
        />
